 ...
 * @LastEditTime: 2021-04-15 14:30:40
 */
/**
 ...
 * @param {*} str
 */
export function computedStrToPx(str) {
  const strArr = [0, 0]
  ...
  return strArr[0] * 10 + strArr[1] * 22
}

// 处理数据
export function dealChartData(data) {
  const dateInfoList = []
