 ...
 * @Version: 0.1.0
 * @Author: AiDongYang
 * @Date: 2021-03-15 18:06:15
 * @LastEditors: AiDongYang
 * @LastEditTime: 2021-04-22 14:55:13
-->
<template>
  <div>
    <SearchFormBox>
...
import { getSemifinishedStatisticsList, semifinishedStatisticsDownload, semifinishedStatisticsDataContrast } from 'src/api/batteryTest'
import { parseTime, downLoadExcel } from 'src/utils'
export default {
  name: 'BatterySemifinishedStatistics',
  components: {
    SearchFormBox,
    TableListBox,
    BatteryModelSelect,
  ...
  methods: {
    ...
    async getList() {
      // 获取列表
      const { data = [], dateList = [] } = await getSemifinishedStatisticsList(this.handleParams())
